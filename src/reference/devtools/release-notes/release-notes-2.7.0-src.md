...
![Open file dialog]({{site.url}}/reference/devtools/release-notes/images-2.7.0/image1.gif "Open file dialog")

* Add a copy button to the call stack view -
  [#3334](https://github.com/flutter/devtools/pull/3334)

![Call stack view]({{site.url}}/reference/devtools/release-notes/images-2.7.0/image2.png "Call stack view")
...
![Profile button]({{site.url}}/reference/devtools/release-notes/images-2.7.0/image3.png "Profile button")
...
![User tag example]({{site.url}}/reference/devtools/release-notes/images-2.7.0/image4.png "User tag examplel")
...
![isolate selector]({{site.url}}/reference/devtools/release-notes/images-2.7.0/image5.png "isolate selector")

* Add class names to CPU stack frames in the profiler -
  [#3385](https://github.com/flutter/devtools/pull/3385)

![Class names]({{site.url}}/reference/devtools/release-notes/images-2.7.0/image6.png "Class names")
