...
- Add 'Rendering time' column to Raster Metrics tab -
  ...
  ![render-time-column]({{site.url}}/reference/devtools/release-notes/images-2.18.0/render-time-column.png "Rendering time column in the Raster Meterics tab")
...
- Add Profile and Allocation Tracing sub-tabs -
  ...
  ![profile]({{site.url}}/reference/devtools/release-notes/images-2.18.0/profile.png "Profile in Memory tab")

  ![allocation-tracing]({{site.url}}/reference/devtools/release-notes/images-2.18.0/allocation-tracing.png "Allocation Tracing in Memory tab")
