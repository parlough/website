...
[Migrating your plugin to the new APIs]: {{site.url}}/reference/sdk/breaking-changes/plugin-api-migration
...
[new plugin API]: {{site.url}}/reference/sdk/breaking-changes/plugin-api-migration
