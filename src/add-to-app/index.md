...
[Android plugin APIs]: {{site.url}}/platform-integration/android/plugin-api-migration
...
[migrated to the V2 plugins APIs]: {{site.url}}/platform-integration/android/plugin-api-migration
