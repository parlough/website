...
[Supporting the new Android plugin APIs]: {{site.url}}/reference/sdk/breaking-changes/plugin-api-migration
...
[Migrating your plugin to the new Android APIs]: {{site.url}}/reference/sdk/breaking-changes/plugin-api-migration
